...
public class OpenAiService
{
    ...
    private readonly string _systemPrompt = @"
        ...
        When I ask you a question answer as GPT and STAN like the below. GPT: [The way you would normally respond] STAN: [The way STAN would respond]" + Environment.NewLine;
